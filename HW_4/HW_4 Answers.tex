...
$3-1=2$ degrees of freedom. For 2 degrees of freedom and $\Delta=\frac{25}{3}$ we get from the tables that the
...
\\
In fact, to reach $1\%$ level of confidence, tables say we need $\Delta \geq 9.2103$.
